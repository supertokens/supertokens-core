...
- Fixes the `BULK_MIGRATION_SLEEP_BETWEEN_ROUNDS_IN_BATCH_MS` environment variable being ignored: env values are now applied to boxed (`Integer`, `Long`, ...) config fields too, not only to primitive ones.
