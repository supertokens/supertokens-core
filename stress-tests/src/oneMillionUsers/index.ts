import { createStInstanceForTest, deleteStInstance, setupLicense } from "../common/utils";
...
async function main() {
    ...
    try {
        ...
        const allUsers: ({ recipeUserId: string, email?: string, phoneNumber?: string } | undefined)[] = [...users.epUsers, ...users.plessEmailUsers, ...users.plessPhoneUsers, ...users.tpUsers1, ...users.tpUsers2];
        ...
        const allUsersForMapping = [...users.epUsers, ...users.plessEmailUsers, ...users.plessPhoneUsers, ...users.tpUsers1, ...users.tpUsers2].filter(user => user !== undefined) as { recipeUserId: string, email?: string, phoneNumber?: string }[];
