...
public class DevProductionAPI extends WebserverAPI {
    private static final long serialVersionUID = -4641988458637882374L;

    public DevProductionAPI(Main main) {
        super(main);
    }

    @Override
    public String getPath() {
        return "/devproductionmode";
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        if ((ProcessHandle.current().pid() + "").equals(pid)) {
            String mode = CLIOptions.get(main).getUserDevProductionMode();
