...
public class JWTDataAPI extends WebserverAPI {
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        try {
            Session.updateSession(this.getTenantIdentifierStorageFromRequest(req), main, sessionHandle, null,
                    userDataInJWT, null);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        try {
            JsonElement jwtPayload = Session.getJWTData(this.getTenantIdentifierStorageFromRequest(req), main,
                    sessionHandle);
