...
public class SessionDataAPI extends WebserverAPI {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        try {
            JsonObject userDataInDatabase = Session.getSessionData(this.getTenantIdentifierStorageFromRequest(req), main, sessionHandle);
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        try {
            Session.updateSession(this.getTenantIdentifierStorageFromRequest(req), main, sessionHandle,
