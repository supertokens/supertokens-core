...
public class ChangePasswordAPI extends WebserverAPI {
    public ChangePasswordAPI(Main main) {
        super(main, RECIPE_ID.EMAIL_PASSWORD.toString());
    }

    @Override
    public String getPath() {
        return "/recipe/user/password/change";
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        if (!method.equals("token")) {
            throw new ServletException(new WebserverAPI.BadRequestException("Unsupported method for password change"));
        }
        ...
        try {
            EmailPassword.redeemPasswordChangeToken(super.main, token, newPassword);
