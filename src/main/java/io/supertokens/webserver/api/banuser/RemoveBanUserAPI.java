...
public class RemoveBanUserAPI extends WebserverAPI {
    private static final long serialVersionUID = -7635191825099655764L;

    public RemoveBanUserAPI(Main main) {
        super(main, RECIPE_ID.BAN_USER.toString());
    }

    @Override
    public String getPath() {
        return "/recipe/ban/user/remove";
    }
