...
public class VerifyEmailAPI extends WebserverAPI {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        try {
            User user = EmailVerification.verifyEmail(this.getTenantIdentifierStorageFromRequest(req),
                    super.main, token);
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            boolean isVerified = EmailVerification.isEmailVerified(this.getTenantIdentifierStorageFromRequest(req), super.main, userId,
                    email);
