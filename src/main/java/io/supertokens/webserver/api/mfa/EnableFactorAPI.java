...
public class EnableFactorAPI extends WebserverAPI {
    private static final long serialVersionUID = -4641988458637882374L;

    public EnableFactorAPI(Main main) {
        super(main, RECIPE_ID.MFA.toString());
    }

    @Override
    public String getPath() {
        return "/recipe/mfa/factors/enable";
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        try {
            ...
            boolean actuallyInserted = Mfa.enableFactor(tenantIdentifierWithStorage, main, userId, factor);

            result.addProperty("status", "OK");
            result.addProperty("didExist", !actuallyInserted);
