...
public class JWTSigningQueries {
    ...
    static String getQueryToCreateJWTSigningTable(Start start) {
        /*
         * created_at should only be used to determine the key that was added to the
         * database last, it should not be used to determine the validity or lifetime of
         * a key. While the assumption that created_at refers to the time the key was
         * generated holds true for keys generated by the core, it is not guaranteed
         * when we allow user defined keys in the future.
         */
