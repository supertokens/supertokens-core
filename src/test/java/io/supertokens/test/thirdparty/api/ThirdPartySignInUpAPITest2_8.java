...
public class ThirdPartySignInUpAPITest2_8 {
    ...
    public void testGoodInput() throws Exception {
        ...
        JsonObject response = Utils.signInUpRequest_2_8(process, "test@examplE.com", "testThirdPartyId",
...

        {
            ...
            assertFalse(EmailVerification.isEmailVerified(process.getProcess(), user.get("id").getAsString(),
    ...
    public void testEmailNormalisation() throws Exception {
        ...
        JsonObject response_1 = Utils.signInUpRequest_2_8(process, "TeSt@example.com", "testThirdPartyId",
                "testThirdPartyUserId");
        checkSignInUpResponse(response_1, "testThirdPartyId", "testThirdPartyUserId", "test@example.com", true);

        JsonObject response_2 = Utils.signInUpRequest_2_8(process, "test@example.com", "testThirdPartyId",
                "testThirdPartyUserId");
