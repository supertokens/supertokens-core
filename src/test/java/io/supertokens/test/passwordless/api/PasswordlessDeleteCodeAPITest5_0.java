...
public class PasswordlessDeleteCodeAPITest5_0 {
    @Rule
    ...
    public void testEmptyRequestBody() throws Exception {
        ...
        assertEquals("Http error. Status Code: 400. Message: Please provide either 'codeId' or 'preAuthSessionId'",
                error.getMessage());
    ...
    @Test
    public void testDeleteNonExistantDeviceIdHash() throws Exception {
        String[] args = {"../"};
        ...
        String preAuthSessionId = "preAuthSessionId";

        JsonObject createCodeRequestBody = new JsonObject();
        createCodeRequestBody.addProperty("preAuthSessionId", preAuthSessionId);
    ...
    @Test
    public void testDeleteDeviceIdHash() throws Exception {
        String[] args = {"../"};
        ...
        JsonObject createCodeRequestBody = new JsonObject();
        createCodeRequestBody.addProperty("preAuthSessionId", deviceIdHash);
