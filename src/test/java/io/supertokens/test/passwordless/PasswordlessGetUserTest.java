...
public class PasswordlessGetUserTest {
    ...
    public void getUserByIdWithEmail() throws Exception {
        ...
        UserInfo user = Passwordless.getUserById(process.getProcess(), consumeCodeResponse.user.getUserIdNotToBeReturnedFromAPI());
        assertNotNull(user);
    ...
    public void getUserByInvalidId() throws Exception {
        ...
        UserInfo user = Passwordless.getUserById(process.getProcess(), consumeCodeResponse.user.getUserIdNotToBeReturnedFromAPI() + "1");
        assertNull(user);
