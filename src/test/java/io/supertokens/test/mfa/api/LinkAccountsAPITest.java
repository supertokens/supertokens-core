...
public class LinkAccountsAPITest {
    ...
    public void linkReturnsTrue() throws Exception {
        ...
        AuthRecipe.createPrimaryUser(process.main, user2.getSupertokensUserId(), true);

        {
            ...
            JsonObject response = HttpRequestForTesting.sendJsonPOSTRequest(process.getProcess(), "",
                    "http://localhost:3567/recipe/mfa/user/link", params, 1000, 1000, null,
        ...
        AuthRecipe.linkAccounts(process.main, user.getSupertokensUserId(), user2.getSupertokensUserId(), true);
    ...
    public void canLinkUserBadInput() throws Exception {
        ...
        AuthRecipeUserInfo user = EmailPassword.signUp(process.getProcess(), "test@example.com", "abcd1234");
        AuthRecipe.createPrimaryUser(process.main, user.getSupertokensUserId(), true);
    ...
    public void linkingUsersFailsCauseAnotherAccountWithSameEmailAlreadyAPrimaryUser() throws Exception {
        ...
        AuthRecipe.CreatePrimaryUserResult result = AuthRecipe.createPrimaryUser(process.main, emailPasswordUser.getSupertokensUserId(), true);
        ...
        AuthRecipe.createPrimaryUser(process.main, signInUpResponse.user.getSupertokensUserId(),true);
    ...
    public void linkingUserFailsCauseAlreadyLinkedToAnotherAccount() throws Exception {
        ...
        AuthRecipe.createPrimaryUser(process.main, emailPasswordUser1.getSupertokensUserId(), true);
        AuthRecipe.linkAccounts(process.main, emailPasswordUser2.getSupertokensUserId(), emailPasswordUser1.getSupertokensUserId(), true);

        AuthRecipeUserInfo emailPasswordUser3 = EmailPassword.signUp(process.getProcess(), "test3@example.com",
                "pass1234");

        AuthRecipe.createPrimaryUser(process.main, emailPasswordUser3.getSupertokensUserId(), true);
