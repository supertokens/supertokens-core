...
public class SessionUserAPITest {
    @Rule
    ...
    public void inputErrorsInSessionUserAPITest() throws Exception {
        ...
        try {
            HttpRequest
                    .sendGETRequest(process.getProcess(), "", "http://localhost:3567/session/user", null, 1000, 1000,
                            null);
            fail();
        ...
        try {
            HttpRequest
                    .sendGETRequest(process.getProcess(), "", "http://localhost:3567/session/user", map, 1000, 1000,
                            null);
            fail();
        } catch (HttpResponseException e) {
            assertTrue(e.statusCode == 400 && e.getMessage()
    ...
    public void differentPossibleSessionUserAPIOutputTest() throws Exception {
        ...
        JsonObject response = HttpRequest
                .sendGETRequest(process.getProcess(), "", "http://localhost:3567/session/user", map, 1000, 1000, null);

        assertEquals(response.get("status").getAsString(), "OK");
        assertEquals(0, response.get("sessionHandles").getAsJsonArray().size());

        //when a session exists
        JsonObject sessionCreatedResponse = HttpRequest
        ...
        JsonObject sessionCreatedResponse1 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
                        new JsonParser().parse(createSessionJsonInput).getAsJsonObject(), 1000, 1000, null);
        ...
        JsonObject sessionCreatedResponse2 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
                        new JsonParser().parse(createSessionJsonInput).getAsJsonObject(), 1000, 1000, null);
    ...
    public void multipleUsersMultipleSessionTest() throws Exception {
        ...
        //UserID1
        //session 1
        JsonObject user1Response1 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
        ...
        //session 2
        JsonObject user1Response2 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
                        new JsonParser().parse(userJsonInput1).getAsJsonObject(), 1000, 1000, null);
        ...
        //session 3
        JsonObject user1Response3 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
                        new JsonParser().parse(userJsonInput1).getAsJsonObject(), 1000, 1000, null);
        ...
        JsonObject user2Response1 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
        ...
        JsonObject user2Response2 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
                        new JsonParser().parse(userJsonInput2).getAsJsonObject(), 1000, 1000, null);
        ...
        JsonObject user2Response3 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
                        new JsonParser().parse(userJsonInput2).getAsJsonObject(), 1000, 1000, null);
        ...
        JsonObject user3Response1 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
        ...
        JsonObject user3Response2 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
                        new JsonParser().parse(userJsonInput3).getAsJsonObject(), 1000, 1000, null);
        ...
        JsonObject user3Response3 = HttpRequest
                .sendJsonPOSTRequest(process.getProcess(), "", "http://localhost:3567/session",
                        new JsonParser().parse(userJsonInput3).getAsJsonObject(), 1000, 1000, null);
