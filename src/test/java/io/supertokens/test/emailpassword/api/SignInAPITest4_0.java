...
public class SignInAPITest4_0 {
    ...
    public void testGoodInputWithUserIdMappingAndMultipleLinkedAccounts() throws Exception {
        ...
        UserIdMapping.createUserIdMapping(process.main, user0.id, "e0", null, false);
        ...
        AuthRecipe.linkAccounts(process.main, user0.id, user.id);
        ...
        }
        {
            ...
            assertEquals(lM.get("recipeUserId").getAsString(), user0.id);
            assertEquals(lM.get("recipeId").getAsString(), "emailpassword");
