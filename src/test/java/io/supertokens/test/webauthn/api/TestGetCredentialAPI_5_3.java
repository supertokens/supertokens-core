...
public class TestGetCredentialAPI_5_3 {
    @Rule
    ...
    public void testInvalidInput() throws Exception {
        ...
        try {
            JsonObject resp = HttpRequestForTesting.sendGETRequest(process.getProcess(), "",
                    "http://localhost:3567/recipe/webauthn/user/credential", params, 1000, 1000, null,
    ...
    private void checkResponseStructure(JsonObject resp) throws Exception {
        ...
        assertEquals(6, resp.entrySet().size());
        assertTrue(resp.has("createdAt"));
        assertTrue(resp.has("updatedAt"));
        assertTrue(resp.has("webauthnCredentialId"));
