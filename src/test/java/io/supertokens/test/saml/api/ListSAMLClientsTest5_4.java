...
public class ListSAMLClientsTest5_4 {
    ...
    @Test
    public void testListAfterCreatingClientViaURL() throws Exception {
        String[] args = {"../"};
        TestingProcessManager.TestingProcess process = TestingProcessManager.start(args);
        assertNotNull(process.checkOrWaitForEvent(ProcessState.PROCESS_STATE.STARTED));
        ...
        assertEquals("https://saml.example.com/entityid", listed.get("idpEntityId").getAsString());
        ...
        assertTrue(listed.has("metadataURL"));
